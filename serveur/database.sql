CREATE USER 'adminrestaurant'@'localhost' IDENTIFIED WITH mysql_native_password BY '!SUperTacos0$28';
GRANT ALL PRIVILEGES ON kata_sql_restaurant . * TO 'adminrestaurant'@'localhost';
FLUSH PRIVILEGES;
